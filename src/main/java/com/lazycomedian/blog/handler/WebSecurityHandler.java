...
import com.lazycomedian.blog.annotation.AccessLimit;
...
import static com.lazycomedian.blog.constant.CommonConst.APPLICATION_JSON;


/**
 * @author lazyComedian
 * @date 2022/12/05 20:13
 **/
@Log4j2
        ...
        if (handler instanceof HandlerMethod) {
            ...
            if (accessLimit != null) {
                ...
                try {
                    ...
                    if (q > maxCount) {
                        render(httpServletResponse, ResultVO.failure("请求过于频繁，请稍候再试"));
